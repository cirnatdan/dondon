...
<main id="main">
<?php include user_only_media . phpdirname(__FILE__) . ('/widgets/user_header.php'); ?>
...
<?php include user_only_media . phpdirname(__FILE__) . ('/widgets/user_recent_images.php'); ?>
</section>
</aside>
...
<?php include user_only_media . phpdirname(__FILE__) . ('/widgets/side_who_to_follow.php'); ?>
<?php include user_only_media . phpdirname(__FILE__) . ('/widgets/side_trending.php'); ?>
<?php include user_only_media . phpdirname(__FILE__) . ('/widgets/side_firefox_addon.php'); ?>
</section>
<?php include user_only_media . phpdirname(__FILE__) . ('/widgets/side_footer.php'); ?>
</aside>
</div>
</main>
<script>
